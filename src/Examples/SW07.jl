function SW07()
    ...
    x_sym = [y_f_m, y_m, k_f, k, c_f_m, c_m, i_f_m, i_m, π_m, w_m, r_m, ε_a, b, ε_g, ε_i,
             ε_r, ε_pm, η_p_aux, ε_wm, η_w_aux]
    y_sym = [k_s_f, k_s, r_f, r, r_k_f, r_k, z_f, z, w_f, w, l_f, l, q_f, q, y_f, y, i_f, i,
             c_f, c, π, μ_pm]
    p = [ε_w, ρ_ga, ε_p, l_bar, Π_bar, B, μ_w, μ_p, α, ψ, φ, δ, σ_c, λ, ϕ_p, ι_w, ξ_w, ι_p,
         ξ_p, σ_l, ϕ_w, r_π, r_Δy, r_y, ρ, ρ_a, ρ_b, ρ_g, ρ_i, ρ_r, ρ_p, ρ_w, γ_bar, gy_ss]
    p_f = []
    ...
    # Defining H
    H = [α * r_k_f + (1 - α) * w_f - ε_a, (1 - ψ) / ψ * r_k_f - z_f,
         w_f + l_f - k_s_f - r_k_f, k_f + z_f - k_s_f,
         ...
         # Sticky Part
         α * r_k + (1 - α) * w - ε_a - μ_pm, (1 - ψ) / ψ * r_k - z, w + l - k_s - r_k,
         k + z - k_s, 1 / (1 + β * γ) * (i_m + β * γ * i_p + 1 / (γ^2 * φ) * q) + ε_i - i,
         -r +
         π_p +
         b / ((1 - λ / γ) / (σ_c * (1 + λ / γ))) +
         ...
         c_y * c + i_y * i + ε_g + z_y * z - y, ϕ_p * (α * k_s + (1 - α) * l + ε_a) - y,
         1 / (1 + β * γ * ι_p) * (β * γ * π_p +
          ι_p * π_m +
          (1 - ξ_p) * (1 - β * γ * ι_p) / (ξ_p * ((ϕ_p - 1) * ε_p + 1)) * μ_pm) + ε_pm - π,
         ...
         ρ * r_m +
         ε_r, (1 - k_1) * k + k_1 * i + k_1 * γ^2 * φ * ε_i - k_p,
         # Shock Transition
         ρ_a * ε_a - ε_a_p, ρ_b * b - b_p, ρ_g * ε_g - ε_g_p, ρ_i * ε_i - ε_i_p,
         ρ_r * ε_r - ε_r_p, ρ_p * ε_pm + η_p_aux_p - μ_p * η_p_aux - ε_pm_p, 0 - η_p_aux_p,
         ρ_w * ε_wm + η_w_aux_p - μ_w * η_w_aux - ε_wm_p, 0 - η_w_aux_p,
         # Variable Mapping
         y_f - y_f_m_p, y - y_m_p, c_f - c_f_m_p, c - c_m_p, i_f - i_f_m_p, i - i_m_p,
         π - π_m_p, w - w_m_p, r - r_m_p]

    x̄ = [y_f_m_ss ~ 0, y_m_ss ~ 0, k_f_ss ~ 0, k_ss ~ 0, c_f_m_ss ~ 0, c_m_ss ~ 0,
          i_f_m_ss ~ 0, i_m_ss ~ 0, π_m_ss ~ 0, w_m_ss ~ 0, r_m_ss ~ 0, ε_a_ss ~ 0,
          b_ss ~ 0, ε_g_ss ~ 0, ε_i_ss ~ 0, ε_r_ss ~ 0, ε_pm_ss ~ 0, η_p_aux_ss ~ 0,
          ε_wm_ss ~ 0, η_w_aux_ss ~ 0]
    ȳ = [k_s_f_ss ~ 0, k_s_ss ~ 0, r_f_ss ~ 0, r_ss ~ 0, r_k_f_ss ~ 0, r_k_ss ~ 0,
          z_f_ss ~ 0, z_ss ~ 0, w_f_ss ~ 0, w_ss ~ 0, l_f_ss ~ 0, l_ss ~ 0, q_f_ss ~ 0,
          q_ss ~ 0, y_f_ss ~ 0, y_ss ~ 0, i_f_ss ~ 0, i_ss ~ 0, c_f_ss ~ 0, c_ss ~ 0,
          π_ss ~ 0, μ_pm_ss ~ 0]
